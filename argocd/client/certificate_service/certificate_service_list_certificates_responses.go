...
// IsSuccess returns true when this certificate service list certificates o k response has a 2xx status code
func (o *CertificateServiceListCertificatesOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this certificate service list certificates o k response has a 3xx status code
func (o *CertificateServiceListCertificatesOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this certificate service list certificates o k response has a 4xx status code
func (o *CertificateServiceListCertificatesOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this certificate service list certificates o k response has a 5xx status code
func (o *CertificateServiceListCertificatesOK) IsServerError() bool {
	return false
}

// IsCode returns true when this certificate service list certificates o k response a status code equal to that given
func (o *CertificateServiceListCertificatesOK) IsCode(code int) bool {
	return code == 200
}
...
func (o *CertificateServiceListCertificatesOK) String() string {
	return fmt.Sprintf("[GET /api/v1/certificates][%d] certificateServiceListCertificatesOK  %+v", 200, o.Payload)
}
...
// IsSuccess returns true when this certificate service list certificates default response has a 2xx status code
func (o *CertificateServiceListCertificatesDefault) IsSuccess() bool {
	return o._statusCode/100 == 2
}

// IsRedirect returns true when this certificate service list certificates default response has a 3xx status code
func (o *CertificateServiceListCertificatesDefault) IsRedirect() bool {
	return o._statusCode/100 == 3
}

// IsClientError returns true when this certificate service list certificates default response has a 4xx status code
func (o *CertificateServiceListCertificatesDefault) IsClientError() bool {
	return o._statusCode/100 == 4
}

// IsServerError returns true when this certificate service list certificates default response has a 5xx status code
func (o *CertificateServiceListCertificatesDefault) IsServerError() bool {
	return o._statusCode/100 == 5
}

// IsCode returns true when this certificate service list certificates default response a status code equal to that given
func (o *CertificateServiceListCertificatesDefault) IsCode(code int) bool {
...
func (o *CertificateServiceListCertificatesDefault) String() string {
	return fmt.Sprintf("[GET /api/v1/certificates][%d] CertificateService_ListCertificates default  %+v", o._statusCode, o.Payload)
}
