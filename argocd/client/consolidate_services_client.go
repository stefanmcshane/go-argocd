...
import (
	...
	"github.com/stefanmcshane/go-argocd/argocd/client/account_service"
	"github.com/stefanmcshane/go-argocd/argocd/client/application_service"
	"github.com/stefanmcshane/go-argocd/argocd/client/application_set_service"
	"github.com/stefanmcshane/go-argocd/argocd/client/certificate_service"
	"github.com/stefanmcshane/go-argocd/argocd/client/cluster_service"
	"github.com/stefanmcshane/go-argocd/argocd/client/g_p_g_key_service"
	"github.com/stefanmcshane/go-argocd/argocd/client/notification_service"
	"github.com/stefanmcshane/go-argocd/argocd/client/project_service"
	"github.com/stefanmcshane/go-argocd/argocd/client/repo_creds_service"
	"github.com/stefanmcshane/go-argocd/argocd/client/repository_service"
	"github.com/stefanmcshane/go-argocd/argocd/client/session_service"
	"github.com/stefanmcshane/go-argocd/argocd/client/settings_service"
	"github.com/stefanmcshane/go-argocd/argocd/client/version_service"
)
...
func New(transport runtime.ClientTransport, formats strfmt.Registry) *ConsolidateServices {
	...
	cli.ApplicationSetService = application_set_service.New(transport, formats)
	...
	cli.NotificationService = notification_service.New(transport, formats)
...
type ConsolidateServices struct {
	...
	ApplicationSetService application_set_service.ClientService
	...
	NotificationService notification_service.ClientService
