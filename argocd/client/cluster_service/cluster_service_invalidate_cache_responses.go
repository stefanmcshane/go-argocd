...
// IsSuccess returns true when this cluster service invalidate cache o k response has a 2xx status code
func (o *ClusterServiceInvalidateCacheOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this cluster service invalidate cache o k response has a 3xx status code
func (o *ClusterServiceInvalidateCacheOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this cluster service invalidate cache o k response has a 4xx status code
func (o *ClusterServiceInvalidateCacheOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this cluster service invalidate cache o k response has a 5xx status code
func (o *ClusterServiceInvalidateCacheOK) IsServerError() bool {
	return false
}

// IsCode returns true when this cluster service invalidate cache o k response a status code equal to that given
func (o *ClusterServiceInvalidateCacheOK) IsCode(code int) bool {
	return code == 200
}
...
func (o *ClusterServiceInvalidateCacheOK) String() string {
	return fmt.Sprintf("[POST /api/v1/clusters/{id.value}/invalidate-cache][%d] clusterServiceInvalidateCacheOK  %+v", 200, o.Payload)
}
...
// IsSuccess returns true when this cluster service invalidate cache default response has a 2xx status code
func (o *ClusterServiceInvalidateCacheDefault) IsSuccess() bool {
	return o._statusCode/100 == 2
}

// IsRedirect returns true when this cluster service invalidate cache default response has a 3xx status code
func (o *ClusterServiceInvalidateCacheDefault) IsRedirect() bool {
	return o._statusCode/100 == 3
}

// IsClientError returns true when this cluster service invalidate cache default response has a 4xx status code
func (o *ClusterServiceInvalidateCacheDefault) IsClientError() bool {
	return o._statusCode/100 == 4
}

// IsServerError returns true when this cluster service invalidate cache default response has a 5xx status code
func (o *ClusterServiceInvalidateCacheDefault) IsServerError() bool {
	return o._statusCode/100 == 5
}

// IsCode returns true when this cluster service invalidate cache default response a status code equal to that given
func (o *ClusterServiceInvalidateCacheDefault) IsCode(code int) bool {
...
func (o *ClusterServiceInvalidateCacheDefault) String() string {
	return fmt.Sprintf("[POST /api/v1/clusters/{id.value}/invalidate-cache][%d] ClusterService_InvalidateCache default  %+v", o._statusCode, o.Payload)
}
