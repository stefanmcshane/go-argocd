...
// WithAppNamespace adds the appNamespace to the application service get params
func (o *ApplicationServiceGetParams) WithAppNamespace(appNamespace *string) *ApplicationServiceGetParams {
	o.SetAppNamespace(appNamespace)
	return o
}

// SetAppNamespace adds the appNamespace to the application service get params
func (o *ApplicationServiceGetParams) SetAppNamespace(appNamespace *string) {
