...
// WithAppNamespace adds the appNamespace to the application service managed resources params
func (o *ApplicationServiceManagedResourcesParams) WithAppNamespace(appNamespace *string) *ApplicationServiceManagedResourcesParams {
	o.SetAppNamespace(appNamespace)
	return o
}

// SetAppNamespace adds the appNamespace to the application service managed resources params
func (o *ApplicationServiceManagedResourcesParams) SetAppNamespace(appNamespace *string) {
