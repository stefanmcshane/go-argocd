...
// IsSuccess returns true when this application service pod logs2 o k response has a 2xx status code
func (o *ApplicationServicePodLogs2OK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this application service pod logs2 o k response has a 3xx status code
func (o *ApplicationServicePodLogs2OK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this application service pod logs2 o k response has a 4xx status code
func (o *ApplicationServicePodLogs2OK) IsClientError() bool {
	return false
}

// IsServerError returns true when this application service pod logs2 o k response has a 5xx status code
func (o *ApplicationServicePodLogs2OK) IsServerError() bool {
	return false
}

// IsCode returns true when this application service pod logs2 o k response a status code equal to that given
func (o *ApplicationServicePodLogs2OK) IsCode(code int) bool {
	return code == 200
}
...
func (o *ApplicationServicePodLogs2OK) String() string {
	return fmt.Sprintf("[GET /api/v1/applications/{name}/logs][%d] applicationServicePodLogs2OK  %+v", 200, o.Payload)
}
...
// IsSuccess returns true when this application service pod logs2 default response has a 2xx status code
func (o *ApplicationServicePodLogs2Default) IsSuccess() bool {
	return o._statusCode/100 == 2
}

// IsRedirect returns true when this application service pod logs2 default response has a 3xx status code
func (o *ApplicationServicePodLogs2Default) IsRedirect() bool {
	return o._statusCode/100 == 3
}

// IsClientError returns true when this application service pod logs2 default response has a 4xx status code
func (o *ApplicationServicePodLogs2Default) IsClientError() bool {
	return o._statusCode/100 == 4
}

// IsServerError returns true when this application service pod logs2 default response has a 5xx status code
func (o *ApplicationServicePodLogs2Default) IsServerError() bool {
	return o._statusCode/100 == 5
}

// IsCode returns true when this application service pod logs2 default response a status code equal to that given
func (o *ApplicationServicePodLogs2Default) IsCode(code int) bool {
...
func (o *ApplicationServicePodLogs2Default) String() string {
	return fmt.Sprintf("[GET /api/v1/applications/{name}/logs][%d] ApplicationService_PodLogs2 default  %+v", o._statusCode, o.Payload)
}
