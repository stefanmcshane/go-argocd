...
// WithAppNamespace adds the appNamespace to the application service terminate operation params
func (o *ApplicationServiceTerminateOperationParams) WithAppNamespace(appNamespace *string) *ApplicationServiceTerminateOperationParams {
	o.SetAppNamespace(appNamespace)
	return o
}

// SetAppNamespace adds the appNamespace to the application service terminate operation params
func (o *ApplicationServiceTerminateOperationParams) SetAppNamespace(appNamespace *string) {
