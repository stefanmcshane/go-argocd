...
// WithAppNamespace adds the appNamespace to the application service update spec params
func (o *ApplicationServiceUpdateSpecParams) WithAppNamespace(appNamespace *string) *ApplicationServiceUpdateSpecParams {
	o.SetAppNamespace(appNamespace)
	return o
}

// SetAppNamespace adds the appNamespace to the application service update spec params
func (o *ApplicationServiceUpdateSpecParams) SetAppNamespace(appNamespace *string) {
