...
// WithAppNamespace adds the appNamespace to the application service list resource events params
func (o *ApplicationServiceListResourceEventsParams) WithAppNamespace(appNamespace *string) *ApplicationServiceListResourceEventsParams {
	o.SetAppNamespace(appNamespace)
	return o
}

// SetAppNamespace adds the appNamespace to the application service list resource events params
func (o *ApplicationServiceListResourceEventsParams) SetAppNamespace(appNamespace *string) {
