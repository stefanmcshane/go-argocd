...
type ClientService interface {
	...
	ApplicationServiceGetManifestsWithFiles(params *ApplicationServiceGetManifestsWithFilesParams, opts ...ClientOption) (*ApplicationServiceGetManifestsWithFilesOK, error)
...
/*
  ApplicationServiceGetManifestsWithFiles gets manifests with files returns application manifests using provided files to generate them
*/
func (a *Client) ApplicationServiceGetManifestsWithFiles(params *ApplicationServiceGetManifestsWithFilesParams, opts ...ClientOption) (*ApplicationServiceGetManifestsWithFilesOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewApplicationServiceGetManifestsWithFilesParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "ApplicationService_GetManifestsWithFiles",
		Method:             "POST",
		PathPattern:        "/api/v1/applications/manifestsWithFiles",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &ApplicationServiceGetManifestsWithFilesReader{formats: a.formats},
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	for _, opt := range opts {
	...
	success, ok := result.(*ApplicationServiceGetManifestsWithFilesOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*ApplicationServiceGetManifestsWithFilesDefault)
	return nil, runtime.NewAPIError("unexpected success response: content available as default response in error", unexpectedSuccess, unexpectedSuccess.Code())
}
