...
// WithAppNamespace adds the appNamespace to the application service get application sync windows params
func (o *ApplicationServiceGetApplicationSyncWindowsParams) WithAppNamespace(appNamespace *string) *ApplicationServiceGetApplicationSyncWindowsParams {
	o.SetAppNamespace(appNamespace)
	return o
}

// SetAppNamespace adds the appNamespace to the application service get application sync windows params
func (o *ApplicationServiceGetApplicationSyncWindowsParams) SetAppNamespace(appNamespace *string) {
