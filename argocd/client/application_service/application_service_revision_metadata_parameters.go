...
// WithAppNamespace adds the appNamespace to the application service revision metadata params
func (o *ApplicationServiceRevisionMetadataParams) WithAppNamespace(appNamespace *string) *ApplicationServiceRevisionMetadataParams {
	o.SetAppNamespace(appNamespace)
	return o
}

// SetAppNamespace adds the appNamespace to the application service revision metadata params
func (o *ApplicationServiceRevisionMetadataParams) SetAppNamespace(appNamespace *string) {
