...
// WithAppNamespace adds the appNamespace to the application service watch resource tree params
func (o *ApplicationServiceWatchResourceTreeParams) WithAppNamespace(appNamespace *string) *ApplicationServiceWatchResourceTreeParams {
	o.SetAppNamespace(appNamespace)
	return o
}

// SetAppNamespace adds the appNamespace to the application service watch resource tree params
func (o *ApplicationServiceWatchResourceTreeParams) SetAppNamespace(appNamespace *string) {
