...
// WithAppNamespace adds the appNamespace to the application service get manifests params
func (o *ApplicationServiceGetManifestsParams) WithAppNamespace(appNamespace *string) *ApplicationServiceGetManifestsParams {
	o.SetAppNamespace(appNamespace)
	return o
}

// SetAppNamespace adds the appNamespace to the application service get manifests params
func (o *ApplicationServiceGetManifestsParams) SetAppNamespace(appNamespace *string) {
