...
// WithAppNamespace adds the appNamespace to the application service patch resource params
func (o *ApplicationServicePatchResourceParams) WithAppNamespace(appNamespace *string) *ApplicationServicePatchResourceParams {
	o.SetAppNamespace(appNamespace)
	return o
}

// SetAppNamespace adds the appNamespace to the application service patch resource params
func (o *ApplicationServicePatchResourceParams) SetAppNamespace(appNamespace *string) {
