...
// WithAppNamespace adds the appNamespace to the application service pod logs params
func (o *ApplicationServicePodLogsParams) WithAppNamespace(appNamespace *string) *ApplicationServicePodLogsParams {
	o.SetAppNamespace(appNamespace)
	return o
}

// SetAppNamespace adds the appNamespace to the application service pod logs params
func (o *ApplicationServicePodLogsParams) SetAppNamespace(appNamespace *string) {
