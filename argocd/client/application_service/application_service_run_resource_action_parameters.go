...
// WithAppNamespace adds the appNamespace to the application service run resource action params
func (o *ApplicationServiceRunResourceActionParams) WithAppNamespace(appNamespace *string) *ApplicationServiceRunResourceActionParams {
	o.SetAppNamespace(appNamespace)
	return o
}

// SetAppNamespace adds the appNamespace to the application service run resource action params
func (o *ApplicationServiceRunResourceActionParams) SetAppNamespace(appNamespace *string) {
