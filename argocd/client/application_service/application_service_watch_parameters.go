...
// WithAppNamespace adds the appNamespace to the application service watch params
func (o *ApplicationServiceWatchParams) WithAppNamespace(appNamespace *string) *ApplicationServiceWatchParams {
	o.SetAppNamespace(appNamespace)
	return o
}

// SetAppNamespace adds the appNamespace to the application service watch params
func (o *ApplicationServiceWatchParams) SetAppNamespace(appNamespace *string) {
