...
// WithAppNamespace adds the appNamespace to the application service get resource params
func (o *ApplicationServiceGetResourceParams) WithAppNamespace(appNamespace *string) *ApplicationServiceGetResourceParams {
	o.SetAppNamespace(appNamespace)
	return o
}

// SetAppNamespace adds the appNamespace to the application service get resource params
func (o *ApplicationServiceGetResourceParams) SetAppNamespace(appNamespace *string) {
