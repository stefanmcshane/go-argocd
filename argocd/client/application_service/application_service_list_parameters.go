...
// WithAppNamespace adds the appNamespace to the application service list params
func (o *ApplicationServiceListParams) WithAppNamespace(appNamespace *string) *ApplicationServiceListParams {
	o.SetAppNamespace(appNamespace)
	return o
}

// SetAppNamespace adds the appNamespace to the application service list params
func (o *ApplicationServiceListParams) SetAppNamespace(appNamespace *string) {
